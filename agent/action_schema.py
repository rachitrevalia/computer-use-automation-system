        ...
        parameters={
            ...
            "properties": {
                "outputs_json": {
                    "type": "string",
                    "description": (
                        'A JSON object ENCODED AS A STRING containing the data the goal asked '
                        'to extract, e.g. \'{"balance": "4210.55"}\'. Must be valid JSON. '
                        "Use exact values as shown on the page, not paraphrased."
                    ),
                },
                "summary": {"type": "string", "description": "One sentence describing what was accomplished."},
                "reasoning": _REASONING_PARAM,
            },
            "required": ["outputs_json", "summary", "reasoning"],
        },
    ),
    types.FunctionDeclaration(
        name="stuck",
